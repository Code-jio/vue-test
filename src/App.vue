...
<template>
  <div id="app">
    ...
    <nav class="app-nav" v-if="showNav">
      <div class="nav-brand">🚀 EngineKernel</div>
      <div class="nav-links">
        <router-link to="/engine-prototype" class="nav-link" active-class="active">
          🔧 引擎原型测试
        </router-link>
        ...
        <router-link to="/model-load-test" class="nav-link" active-class="active">
          📊 模型加载性能测试
        </router-link>
